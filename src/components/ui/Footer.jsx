...
const Footer = () => {
  const service = [{id: 1, name: 'บริการตามน้ำหนัก'}, {id: 2, name: 'บริการตามชิ้น'}, {id: 4, name: 'บริการด่วนพิเศษ'} ];
  const contact = [{id: 1, name: '📞 02-xxx-xxxx'}, {id: 2, name: '📧 info@whalewash.com'}, {id: 3, name: '📍 กรุงเทพมหานคร'}];
  const openTime = [{id: 1, name: 'จันทร์ - ศุกร์: 8:00 - 18:00'}, {id: 2, name: 'เสาร์ - อาทิตย์: 9:00 - 18:00'} ];
  return (
    <div>
